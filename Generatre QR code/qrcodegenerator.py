...
def generate():
    ...
    Label(cp, text='File Saved!', bg='#7a7a7a' , fg='black', font=('Arial Black', 8)).pack()
...
Label(frame, text='File Name(Save As) : ', font=('Arial Black', 16),
      bg='#7a7a7a').grid(row=1, column=0, sticky='w')
